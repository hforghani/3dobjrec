...
desc_model_f_name = ['data/model_desc_' case_name];
...
for i = 1:obj_count
    model_f_name = ['data/model_' desc_model.obj_names{i}];
    load(model_f_name);
